...
from .models import (
    Client, Commande, CommandeRepas, StatutCommande, HistoriqueStatutCommande, PointRecup,
    ...
    Livraison, StatutLivraison, HistoriqueStatutLivraison, ZoneRestaurant, ZoneClient, RestaurantRepas, TypeRepas,
    DisponibiliteRepas
)
