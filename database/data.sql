...
INSERT INTO core_pointrecup (id, nom, geo_position) VALUES
(1, 'Analakely - Place de l''Independance', 'POINT(47.5290 -18.9100)'),
(2, 'Andravoahangy - Marche couvert', 'POINT(47.5380 -18.8900)'),
(3, 'Ankorondrano - Station Jovenna', 'POINT(47.5250 -18.8800)'),
(4, 'Ivandry - Centre commercial', 'POINT(47.5420 -18.8700)'),
(5, 'Ankadimbahoaka - Parking Shoprite', 'POINT(47.5200 -18.9250)'),
(6, 'Analakely - Gare routiere', 'POINT(47.5320 -18.9060)'),
(7, 'Ankorondrano - Galerie Zital', 'POINT(47.5230 -18.8750)');

INSERT INTO core_livreur (id, nom, contact, position, date_inscri) VALUES
(1, 'Rabe Andriamalala', '+261331234574', 'POINT(47.5300 -18.9110)', '2025-01-10 09:15:22'),
(2, 'Jean Rakotomalala', '+261341234575', 'POINT(47.5370 -18.8910)', '2025-01-15 14:30:45'),
(3, 'Marie Rasoanaivo', '+261321234576', 'POINT(47.5240 -18.8790)', '2025-02-05 11:20:33'),
(4, 'Paul Randriamampianina', '+261331234577', 'POINT(47.5410 -18.8710)', '2025-02-20 16:45:12'),
(5, 'Tiana Raharimalala', '+261341234578', 'POINT(47.5210 -18.9240)', '2025-03-08 08:10:56'),
(6, 'Faly Andrianarisoa', '+261331234579', 'POINT(47.5310 -18.9070)', '2025-03-22 13:25:41'),
(7, 'Solo Ramaroson', '+261321234580', 'POINT(47.5220 -18.8760)', '2025-04-05 17:50:19');
...
(6, 1, '2025-06-01 08:00:00'), (6, 2, '2025-06-01 11:30:00'), (6, 1, '2025-06-01 13:15:00'),
(7, 3, '2025-06-01 00:00:00');

INSERT INTO core_repas (id, nom, prix, description, image, type_id) VALUES
(1, 'Ravitoto sy henakisoa', 15000, 'Feuilles de manioc pilees avec viande de porc', 'ravitoto.jpg', 1),
(2, 'Romazava', 12000, 'Bouillon de viande avec bredes malgaches', 'romazava.jpg', 1),
(3, 'Varanga', 18000, 'Viande de zebu mijotee avec legumes', 'varanga.jpg', 1),
(4, 'Poulet coco', 14000, 'Poulet cuit dans du lait de coco', 'poulet_coco.jpg', 1),
(5, 'Lasopy', 10000, 'Soupe de legumes malgache', 'lasopy.jpg', 1),
(6, 'Brochettes de zebu', 8000, 'Brochettes de viande de zebu grillee', 'brochette_zebu.jpg', 1),
(7, 'Pizza malgache', 20000, 'Pizza garnie de produits locaux', 'pizza_malgache.jpg', 1),
(8, 'Hamburger zebu', 16000, 'Burger avec steak de zebu', 'burger_zebu.jpg', 1),

(9, 'Samoussa', 3000, 'Beignets triangulaires farcis', 'samoussa.jpg', 2),
(10, 'Nem', 3500, 'Rouleaux de printemps frits', 'nem.jpg', 2),
(11, 'Salade malgache', 7000, 'Salade de legumes frais', 'salade_malgache.jpg', 2),
(12, 'Soupe de crevettes', 9000, 'Soupe a base de crevettes fraiches', 'soupe_crevette.jpg', 2),

(13, 'Mofo gasy', 2000, 'Petits gateaux de riz', 'mofo_gasy.jpg', 3),
(14, 'Koba', 3000, 'Gateau a base de banane et cacahuetes', 'koba.jpg', 3),
(15, 'Bonbon coco', 2500, 'Confiserie a base de noix de coco', 'bonbon_coco.jpg', 3),
(16, 'Glace artisanale', 5000, 'Glace faite maison parfum vanille', 'glace_vanille.jpg', 3),

(17, 'THB Pilsener', 4000, 'Biere locale', 'thb_pilsener.jpg', 4),
(18, 'Ranona', 2000, 'Jus de canne a sucre', 'ranona.jpg', 4),
(19, 'Jus de litchi', 3500, 'Jus de fruit frais', 'jus_litchi.jpg', 4),
(20, 'Eau minerale', 1500, 'Eau en bouteille', 'eau.jpg', 4),

(21, 'Akoho sy voanio', 13000, 'Poulet au coco', 'akoho_voanio.jpg', 5),
(22, 'Vary amin''anana', 10000, 'Riz aux bredes', 'vary_anana.jpg', 5),
(23, 'Kitoza', 9000, 'Viande sechee de zebu', 'kitoza.jpg', 5),
(24, 'Ravitoto voatabia', 16000, 'Ravitoto avec tomate', 'ravitoto_voatabia.jpg', 5);
...
INSERT INTO core_commande (id, client_id, point_recup_id, cree_le, mode_paiement_id) VALUES
(1, 1, 1, '2025-06-01 12:30:45', 1),
(2, 2, 2, '2025-06-01 13:15:22', 2),
(3, 3, 3, '2025-06-02 11:45:33', 3),
(4, 4, 4, '2025-06-02 14:20:15', 1),
(5, 5, 5, '2025-06-03 12:10:42', 2),
(6, 6, 6, '2025-06-03 13:25:18', 3),
(7, 7, 7, '2025-06-04 11:30:56', 1),
(8, 1, 1, '2025-06-04 13:45:27', 2),
(9, 2, 2, '2025-06-05 12:15:39', 3),
(10, 3, 3, '2025-06-05 14:30:12', 1),
(11, 4, 4, '2025-06-06 12:40:48', 2),
(12, 5, 5, '2025-06-06 13:55:23', 3),
(13, 6, 6, '2025-06-07 11:20:17', 1),
(14, 7, 7, '2025-06-07 14:10:35', 2),
(15, 1, 1, '2025-06-08 12:50:42', 3);
...
INSERT INTO core_livraison (id, commande_id, livreur_id, attribue_le) VALUES
(1, 1, 1, '2025-06-01 12:40:00'),
(2, 2, 2, '2025-06-01 13:25:00'),
(3, 3, 3, '2025-06-02 12:00:00'),
(4, 4, 4, '2025-06-02 14:30:00'),
(5, 5, 5, '2025-06-03 12:20:00'),
(6, 6, 6, '2025-06-03 13:35:00'),
(7, 7, 1, '2025-06-04 11:40:00'),
(8, 8, 2, '2025-06-04 13:55:00'),
(9, 9, 4, '2025-06-05 12:25:00'),
(10, 10, 5, '2025-06-05 14:40:00'),
(11, 11, 6, '2025-06-06 12:50:00'),
(12, 12, 1, '2025-06-06 14:05:00'),
(13, 13, 2, '2025-06-07 11:30:00'),
(14, 14, 4, '2025-06-07 14:20:00'),
(15, 15, 5, '2025-06-08 13:00:00');
